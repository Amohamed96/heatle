...
export const InfoModal = ({ isOpen, handleClose }: Props) => {
  return (
    <BaseModal title="How to play Heatle" isOpen={isOpen} handleClose={handleClose}>
      <p className="text-sm text-gray-500 dark:text-gray-300">
        Heatle is a game inspired by Wordle where you guess the word in 6 tries. After each guess, the color of the tiles will
